...
namespace DJTWAINTESTNET48
{
    ...
    {
        private readonly DJTWAIN dJTWAIN = new DJTWAIN();
        ...
        private void ButtonSelectScanSoucre_Click(object sender, System.EventArgs e)
        {
            selected = (string)ListBoxSourceSelect.SelectedItem;
            this.DialogResult = DialogResult.OK;
        }

        private void ListBoxSourceSelect_DoubleClick(object sender, System.EventArgs e)
        {
            selected = (string)ListBoxSourceSelect.SelectedItem;
            this.DialogResult = DialogResult.OK;
        }
