...
namespace SealTypographicWebAPI.Services.Implements
{
    ...
    /// 會計師資料管理
    /// </summary>
    public class AccountantServiceExtension : IAccountantService
    {
        ...
        public AccountantServiceExtension(SealTypographicExtensionDbContext dbContext, IMapper mapper)
        {
