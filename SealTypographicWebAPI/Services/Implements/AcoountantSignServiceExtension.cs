...
namespace SealTypographicWebAPI.Services.Implements
{
    ...
    /// 會計師簽印管理
    /// </summary>
    public class AcoountantSignServiceExtension : IAccountantSignService
    {
        ...
        public AcoountantSignServiceExtension(SealTypographicExtensionDbContext dbContext, IMapper mapper, ImageService imageService)
        {
            ...
            AccountantSignGroupResponse accountantSignStartDates = new()
            {
                AccountantSignGroups = dbContext.AccountantSignGroups
                                                       ...
                                                       .Select(accountantSignGroup => new AccountantSignGroupViewModel()
                                                       {
                                                           ...
                                                           ReviewStatus = (DBEntities.Consts.ReviewStatus)accountantSignGroup.ReviewStatus
                                                       })                                                       
        ...
        public AccountantSignViewModels GetSignViewModels(int accountantSignGroupId)
        {
            ...
            if (accountantSignGroupJournalQuery != null)
            {
                ...
                foreach (TypographicResource typographyResource in accountantSigns)
                {
                    ...
                    accountantSignViewModel.SealMappingConfigId = (DBEntities.Consts.AccountantSignType)SealMappingConfigUtil.GetAccountantSignType(typographyResource.SubSealType);
                ...
                //之後調整ReviewStatus不需轉型
                signViewModels.ReviewStatus = (DBEntities.Consts.ReviewStatus)accountantSignGroupJournalQuery.ReviewStatus;                                
            }
        ...
        public async Task<ResponseViewModel> New(AccountantSignForms accountantSignForms)
        {
            ...
            {                
                ...
                //之後調整無需轉型
                ImageBase64Info imageBase64Info = imageService.SetImageBase64InfoWithSeal(accountantQuery.Code, (DBEntities.Consts.SealType)SealType.Accountant);
        ...
        public async Task<List<ResponseViewModel>> Update(AccountantSignUpdate accountantSignUpdate)
        {
            ...
            if (accountantSignGroupQuery != null)
            {
                ...
                if(accountant != null)
                {
                    ...
                    //之後拔除轉型調整
                    ImageBase64Info imageBase64Info = imageService.SetImageBase64InfoWithSeal(accountant.Code, (DBEntities.Consts.SealType)SealType.Accountant);
                    ...
                    foreach (AccountantSignUpdateForm accountantSignFormUpdate in accountantSignUpdate.UpdateAccountantSigns)
                    {
                        ...
                        if (updateSignQuery != null)
                        {
                            AccountantSign accountantSign = new()
                            {
                                ...
                                SealMappingConfigId = (DBEntities.Consts.AccountantSignType)SealMappingConfigUtil.GetAccountantSignType(updateSignQuery.SubSealType),
                            };
