...
namespace SealTypographicWebAPI.Services.Implements
{
    ...
    /// 信頭圖片管理
    /// </summary>
    public class LetterheadImageServiceExtension : ILetterheadImageService
    {
        private readonly SealTypographicExtensionDbContext dbContext;
        private readonly ImageService imageService;                
        private readonly IStringLocalizer<LetterheadImageServiceExtension> localizer;
        ...
        public LetterheadImageServiceExtension(SealTypographicExtensionDbContext dbContext, ImageService imageSharpService, IStringLocalizer<LetterheadImageServiceExtension> localizer)
        {
            ...
            if (letterhead != null)
            {
                ...
                letterheadImageCreateDateViews.CreateDateViews = letterhead.TypographyResources
                                                                ...
                                                                .Select(typographyResource => new LetterheadImageCreateDateView()
                                                                {
                                                                    ...
                                                                    Status = (DBEntities.Consts.LetterheadImageStatus)letterhead.Status
                                                                })
        ...
        public async Task<ResponseViewModel> New(LetterheadImageForm letterheadImageForm)
        {
            ...
            {
                ImageBase64Info imageBase64Info = imageService.SetImageBase64InfoWithSeal(companyQuery.Code, (DBEntities.Consts.SealType)SealType.Letterhead);                
