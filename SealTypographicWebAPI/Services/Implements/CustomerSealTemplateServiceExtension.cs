...
namespace SealTypographicWebAPI.Services.Implements
{
    ...
    /// 客戶印鑑樣板
    /// </summary>
    public class CustomerSealTemplateServiceExtension : ICustomerSealTemplateService
    {
        ...
        public CustomerSealTemplateServiceExtension(SealTypographicExtensionDbContext dbContext, IMapper mapper, ImageService imageService)
        {
        ...
        public async Task<ResponseViewModel> New(CustomerSealTemplateForm customerSealTemplateForm)
        {
            ...
            {                
                ...
                //儲存圖片(原圖)
                ImageBase64Info imageBase64Info = imageService.SetImageBase64InfoWithTemplate(companyQuery.Code, (DBEntities.Consts.SealType)SealType.Customer);
