...
namespace SealTypographicWebAPI.Services.Implements
{
    ...
    /// 會計師簽印樣板管理
    /// </summary>
    public class LetterheadImageTemplateServiceExtension : ILetterheadImageTemplateService
    {
        ...
        public LetterheadImageTemplateServiceExtension(SealTypographicExtensionDbContext dbContext, IMapper mapper, ImageService imageSharpService)
        {
        ...
        public async Task<ResponseViewModel> New(LetterheadImageTemplateForm letterheadImageTemplateForm)
        {
            ...
            {                
                ...
                //儲存圖片(原圖)
                ImageBase64Info imageBase64Info = imageService.SetImageBase64InfoWithTemplate(companyQuery.Code, (DBEntities.Consts.SealType)SealType.Letterhead);
