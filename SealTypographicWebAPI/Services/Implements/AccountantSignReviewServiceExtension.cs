...
namespace SealTypographicWebAPI.Services.Implements
{
    ...
    /// 會計師簽印審核管理    
    /// </summary>
    public class AccountantSignReviewServiceExtension : IAccountantSignReviewService
    {
        ...
        public AccountantSignReviewServiceExtension(SealTypographicExtensionDbContext dbContext, IMapper mapper, ImageService imageService)
        {
        ...
        public AccountantSignGroupReviewPaginate GetReviewPaginate(AccountantSignSearchReview accountantSignSearchReview)
        {
            ...
            {
                //取得該頁            
                List<AccountantSignGroup> thisPageAccountantSignQuarter = accountantSignGroupQuery
                ...
                foreach (AccountantSignGroup accountantSignGroup in thisPageAccountantSignQuarter)
                {
                    ...
                    foreach (TypographicResource typographyResource in FilterAccountantSigns(accountantSignGroup.TypographicResources))
                    {
                        ...
                        {
                            SealMappingConfigId = (DBEntities.Consts.AccountantSignType)SealMappingConfigUtil.GetAccountantSignType(typographyResource.SubSealType),                            
                        };
